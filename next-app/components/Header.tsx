                        ...
                        if (!connected) {
                          return (
                            <div className=''>
                              ...
                              <div className='fixed left-1/2 -translate-x-1/2 top-5 grid grid-cols-2 gap-3 backdrop-blur-md w-full -mt-5 pt-5'>
                                ...
                                <Link href="https://certamentransparencia.org.mx/">
                                  <div className='text-center'>
                                    <Image 
                                      ...
                                      className='cursor-pointer hover:opacity-100 rounded-full opacity-50'/>
                                  </div>
                                </Link>
                                <div className='grid grid-cols-3 gap-3 grid items-center mx-auto'>
                              ...
                              <button className='homeBT fixed bottom-5 left-1/2 -translate-x-1/2 backdrop-blur-md' onClick={openConnectModal} type="button">
                                Conectar
                              </button>
                            </div>
                          );
