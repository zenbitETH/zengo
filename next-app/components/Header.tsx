                        ...
                        if (!connected) {
                          return (
                            <div className=''>
                              ...
                              <div className='fixed left-1/2 -translate-x-1/2 top-5 grid grid-cols-2 gap-5 backdrop-blur-md w-full -mt-5 pt-5'>
